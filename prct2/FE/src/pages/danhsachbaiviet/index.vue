          ...
          <div class="card-body">
            <div class="row">
              <div class="mb-3 col-lg-3">
                ...
                <input v-model="itemFilter.content" type="text" name="untyped-input" class="form-control"
                  placeholder="Tìm kiếm theo tiêu đề" style="height: 39px;" />
              </div>
              <div class="mb-3 col-lg-3">
                <label>Thời gian bắt đầu</label>
                <date-picker v-model="itemFilter.ngayBatDau" format="DD/MM/YYYY"></date-picker>
              </div>
              <div class="mb-3 col-lg-3">
                <label>Thời gian kết thúc</label>
                <date-picker v-model="itemFilter.ngayKetThuc" format="DD/MM/YYYY"></date-picker>
              </div>
              <div class="mb-3 col-lg-3">
                <label>Chuyên mục tin</label>
                <treeselect v-on:select="addCoQuanToModel" :normalizer="normalizer" :options="treeView"
                  :value="itemFilter.menuId" :multiple="false" placeholder="Chọn chuyên mục tin">
                  <label style="height: 39px;" slot="option-label"
            ...
            <div class="row">
              <div class="col-12 text-center">
                <b-button variant="" class="w-10 btn-search"
                ...
                <b-button class="w-10 btn-reset"
                  style="margin-right: 10px; height: 40px ; width: 130px; font-size: 14px; background-color: #F2B705; border: none; color: #000 !important; font-weight: bold;"
                  size="sm" @click="handleClear">
                    ...
                    <template v-slot:cell(menu)="data">
                      <div v-for="(item, index) in data.item.menu" :key="index">
                        <span class="badge bg-warning mb-1"
                          style="padding: 5px; color: #1e2125; text-transform: uppercase; font-weight: bold;">{{
                          item.name }}</span>
                      </div>
                    </template>
                    ...
                    <template v-slot:cell(process)="data">
                      <router-link :to="{
                        ...
                        <button
                          ...
                          type="button" size="sm" class="btn btn-outline btn-sm">
