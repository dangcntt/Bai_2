  ...
  methods: {
    ...
    async handleDelete() {
      if (this.model.id != 0 && this.model.id != null && this.model.id) {
        await this.$store
          .dispatch("userStore/delete", { id: this.model.id })
          .then((res) => {
            if (res.code === 0) {
              this.fnGetList();
    ...
    async handleSubmit(e) {
      ...
      if (this.$v.$invalid) {
        ...
        if (this.model.id != 0 && this.model.id != null && this.model.id) {
          ...
          // Update model
          await this.$store
            .dispatch("userStore/update", this.model)
            .then((res) => {
              if (res.code === 0) {
          ...
          await this.$store
            .dispatch("userStore/create", this.model)
            .then((res) => {
              if (res.code === 0) {
                this.fnGetList();
                this.showModal = false;
    ...
    async handleUpdate(id) {
      await this.$store
        .dispatch("userStore/getById", { id: id })
        .then((res) => {
          if (res.code === 0) {
            console.log(res);
                        ...
                        <div class="col-6">
                          <div class="mb-3">
                            ...
                            <multiselect
                              ...
                              :class="{
                                'is-invalid':
                                  submitted && $v.model.unitRole.$error,
                              }"
